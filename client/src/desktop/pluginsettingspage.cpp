...
PluginSettingsPage::PluginSettingsPage(const QString &pluginId, QWidget *parent) :
    SettingsPage(parent),
    m_layout(new QFormLayout(this)),
    m_pluginId(pluginId)
{
    PluginSettings::instance()->getSettings(pluginId);
    connect(PluginSettings::instance(), SIGNAL(ready(QString, QVariantList)), this, SLOT(onSettingsReady(QString, QVariantList)));
}

void PluginSettingsPage::save() {
    if (!m_settings.isEmpty()) {
        PluginSettings::instance()->setSettings(m_pluginId, m_settings);
    }
}
...
void PluginSettingsPage::onSettingsReady(const QString &pluginId, const QVariantList &settings) {
    ...
    disconnect(PluginSettings::instance(), SIGNAL(ready(QString, QVariantList)),
            this, SLOT(onSettingsReady(QString, QVariantList)));
}
