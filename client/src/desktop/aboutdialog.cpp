    ...
    m_layout(new QVBoxLayout(this))
{
    ...
    m_textLabel->setText(QString("<div style='text-align: center'><p style='font-size: 16pt; font-weight: bold;'>QDL-Client</p><p>Version: %1</p><p>A client application for QDL, a plugin-based download manager.</p><p>&copy; Stuart Howarth 2018</p><p><a href='http://marxoft.co.uk/projects/qdl'>marxoft.co.uk</a></p></div><p>Installed plugins:</p>").arg(VERSION_NUMBER));
