...
#ifndef FILEJOKERPLUGIN_H
#define FILEJOKERPLUGIN_H
...
class FileJokerPlugin : public ServicePlugin
{
    Q_OBJECT
    
public:
    explicit FileJokerPlugin(QObject *parent = 0);
...
class FileJokerPluginFactory : public QObject, public ServicePluginFactory
{
    Q_OBJECT
    Q_INTERFACES(ServicePluginFactory)
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "org.qdl2.FileJokerPluginFactory")
#endif
