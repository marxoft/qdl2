...
#ifndef PUBLISHTOMEPLUGIN_H
#define PUBLISHTOMEPLUGIN_H
...
class PublishToMePlugin : public ServicePlugin
{
    Q_OBJECT
    
public:
    explicit PublishToMePlugin(QObject *parent = 0);
...
class PublishToMePluginFactory : public QObject, public ServicePluginFactory
{
    Q_OBJECT
    Q_INTERFACES(ServicePluginFactory)
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "org.qdl2.PublishToMePluginFactory")
#endif
